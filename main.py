...
def main(users, action=False):
    ...
    if action:
        ...
        logging.info("严格等待到北京时间00:04:00...")
        wait_until("00:04:00", action)
        logging.info("北京时间00:04:00 - 开始登录账号")
        ...
        logging.info("严格等待到北京时间00:05:00...")
        wait_until("00:05:00", action)
        logging.info("北京时间00:05:00 - 开始预约流程")
