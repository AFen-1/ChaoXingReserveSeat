...
def main(users, action=False):
    ...
    if action:
        ...
        logging.info("严格等待到北京时间21:06:00...")
        wait_until("21:06:00", action)
        logging.info("北京时间21:06:00 - 开始登录账号")
        ...
        logging.info("严格等待到北京时间21:07:00...")
        wait_until("21:07:00", action)
        logging.info("北京时间21:07:00 - 开始预约流程")
