...
def main(users, action=False):
    ...
    if action:
        ...
        logging.info("严格等待到北京时间16:25:00...")
        wait_until("16:25:00", action)
        logging.info("北京时间16:25:00 - 开始登录账号")
        ...
        logging.info("严格等待到北京时间16:26:00...")
        wait_until("16:26:00", action)
        logging.info("北京时间16:26:00 - 开始预约流程")
