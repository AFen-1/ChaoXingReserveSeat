...
def main(users, action=False):
    ...
    if action:
        ...
        # 第一步：严格等待到北京时间23:10:00
        logging.info("严格等待到北京时间23:45:00...")
        wait_until("23:45:00", action)
        logging.info("北京时间23:45:00 - 开始登录账号")
        ...
        logging.info("严格等待到北京时间23:46:00...")
        wait_until("23:46:00", action)
        logging.info("北京时间23:46:00 - 开始预约流程")
