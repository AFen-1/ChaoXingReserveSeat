...
def main(users, action=False):
    ...
    if action:
        ...
        # 第一步：等待到北京时间21:29
        logging.info("等待到北京时间23:07...")
        wait_until("23:07:00", action)
        logging.info("北京时间23:07 - 开始登录账号")
        ...
        # 第二步：等待到北京时间21:30
        logging.info("等待到北京时间23:08...")
        wait_until("23:08:00", action)
        logging.info("北京时间23:08 - 开始预约流程")
