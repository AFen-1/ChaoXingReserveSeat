...
def main(users, action=False):
    ...
    if action:
        ...
        logging.info("严格等待到北京时间22:31:00...")
        wait_until("22:31:00", action)
        logging.info("北京时间22:31:00 - 开始登录账号")
        ...
        logging.info("严格等待到北京时间22:32:00...")
        wait_until("22:32:00", action)
        logging.info("北京时间22:32:00 - 开始预约流程")
